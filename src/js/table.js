...
var merge = require('./exp2.js').merge;
var ufoFn = require('./workinfo.js').ufoFn;
var myInfoFn = require('./myinfo.js');
...
function change(){
    ...
    var num = 0;
    var num2 = 0;
    var arr = [document.getElementById('exp'),document.getElementById('work'),document.getElementById('description'),document.getElementById('skill')];
